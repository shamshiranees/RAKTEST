...
class DeviceDetailsModule: NSObject {
  ...
  @objc
    func getDeviceModel(_ resolve: RCTPromiseResolveBlock, rejecter reject: RCTPromiseRejectBlock) {
      ...
      resolve(["device":mapToDevice(identifier: identifier),"ip":ipAddress[0],"macAddress":macAddress,"deviceName":deviceName,"version":version,"modelName":modelName,"osName":osName,"localized":localized])
